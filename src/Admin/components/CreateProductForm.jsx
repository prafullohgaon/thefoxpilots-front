      ...
      <Typography
        ...
        <form onSubmit={handleSubmit} className='createProductContainer min-h-screen'>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              <TextField fullWidth label="Discounte Price" name="discountedPrice" value={productData.discountedPrice} onChange={handleChange} type='number'/>
            </Grid>
            <Grid item xs={12} sm={4}>
              <TextField fullWidth label="Discounte Percentage" name="discountPersent" value={productData.discountPersent} onChange={handleChange} type='number'/>
            </Grid>
            <Grid item xs={6} sm={4}>
            ...
            {productData.size.map((size,index)=>(
              <Grid container item spacing={3}>
                {/* <Grid item xs={12} sm={6}>
                  <TextField label="Size Name" name="name" value={(event)=> handleSizeChange(event, index)} required fullWidth/>
                </Grid> */}
                <Grid item xs={12} sm={6}>
                  <TextField label="Size Name" name='name' onChange={(event)=> handleSizeChange(event, index)} required fullWidth/>
