...
import { Button, Rating, Grid, LinearProgress, Box } from "@mui/material";
...
export default function ProductDetails() {
  ...
  console.log("-------------", params)
  console.log("Product ID from useParams:", params.productId);
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          {/* Product info */}
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
        ...
        {/* Rating and reviews */}
        <section className="">
            <h1 className="font-semibold text-lg pg-4">Recent Review & Rating</h1>
